          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-neutral-50/50 border-b border-neutral-200 text-neutral-500 font-medium">
              <tr>
                ...
                <th className="px-6 py-4">Bàn/Ghế</th>
                ...
                filteredGuests.map((guest) => {
                  ...
                  return (
                    <tr key={guest.id} className="hover:bg-neutral-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-neutral-600">{guest.phone || "-"}</div>
                        <div className="text-xs text-neutral-400">{guest.email || "-"}</div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center justify-center bg-neutral-100 text-neutral-600 px-2.5 py-1 rounded-md text-xs font-medium">
                          Bàn {guest.table_number || "?"} - Ghế {guest.seat_number || "?"}
                        </span>
                      </td>
                      <td className="px-6 py-4">
            ...
            <form onSubmit={handleSave} className="p-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-neutral-600 mb-1.5">Số điện thoại</label>
                    <input
                      type="tel"
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-neutral-600 mb-1.5">Số người</label>
                    <input
                      type="number"
                      min="1"
                      required
                  ...
                  <div>
                    <label className="block text-sm font-medium text-neutral-600 mb-1.5">Số Bàn</label>
                    <input
                      type="number"
                      value={editingGuest?.table_number || ""}
                      onChange={(e) => setEditingGuest({ ...editingGuest, table_number: e.target.value ? parseInt(e.target.value) : undefined })}
                      className="w-full px-4 py-2.5 rounded-xl border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-neutral-900 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-neutral-600 mb-1.5">Số Ghế</label>
                    <input
                      type="number"
